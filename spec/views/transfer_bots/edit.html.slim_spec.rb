...
RSpec.describe "transfer_bots/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit transfer_bot form" do
    render

    assert_select "form[action=?][method=?]", transfer_bot_path(@transfer_bot), "post" do
